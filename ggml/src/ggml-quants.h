...
GGML_API void quantize_row_kivi_2_ref(const float * GGML_RESTRICT x, block_kivi_2 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_kivi_2(const block_kivi_2 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
